package com.aaomidi.days.day8;

import com.aaomidi.model.Problem;
import org.apache.commons.lang3.StringEscapeUtils;

/**
 * Created by amir on 2015-12-08.
 */
public class P extends Problem {
    private final String input = "\"\\xa8br\\x8bjr\\\"\"\n" +
            "\"nq\"\n" +
    ...
    private int part2Size = 0;
    private int totalSize = 0;


    public P() {
        super("Day 8: Matchsticks");
        //input = new File(this.getClass().getResource("/day8.txt").getFile());
        //input = new File("D:\\Dropbox\\Coding\\Java\\College\\Public\\AdventOfCode\\src\\main\\resources\\day8.txt");
    }
    ...
    public String solvePart1() {
        ...
        for (String s : input.split("\n")) {
            ...
            while (offset < s.length()) {
                ...
                if (curChar == 34) { // quo te
                    codeSize--;
                } else if (curChar == 92) { // slash
                    codeSize--;
        ...
        return (totalSize - codeSize) + "";
    }


    @Override
    public String solvePart2() {
        return (part2Size-totalSize) + "";
    }
}